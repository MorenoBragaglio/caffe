...
inline HybridAutomaton getT2()
{
    RealConstant rate("rate",0.3_decimal);
    RealConstant rate_T2("rate_T2",0.3_decimal);
    ...
    t2.new_mode(draining,{dot(height_T2)= rate_T2*aperture_V_OUT_T1 - rate*aperture_V_OUT_T2});
